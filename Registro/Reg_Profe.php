                    ...
                    <form name="alta_profe" action="<?php echo $_SERVER['PHP_SELF'];?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div class="panel panel-success">
                                <div class="panel-heading">Por favor introduzca los datos solicitados.<br>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-4 col-md-offset-1">
                                                    <label for="secus">Estas son las secundarias registradas en educatorium</label>
                                                </div>
                                                <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-offset-1">
                                                    <label class="label label-default"><span class="label-danger">&nbsp;NOTA:&nbsp;</span>
