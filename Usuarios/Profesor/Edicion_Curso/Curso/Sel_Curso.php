    ...
    <body>
        <div class="container">
            <div class="form-group">
                <div class="row title">
                    <div class="col-md-10">
                        <h1 align="center">Por favor seleccione el curso que desea editar</h1>
                    </div>
                    <div class="col-md-2">
                        ...
                        for($fils=0;$fils<$cont/3;$fils++)
                        {
                            ...
                            for($cols=$fils*3,$cont1=0;$cont1<=2;$cols++,$cont1++)
                            {
                                ...
                                echo '<div class="col-md-3 col-md-offset-1 text-center" style="border: 2px solid black; border-radius: 15px; background-color: lightgreen;">'.
                                        '<input type="radio" name="CurSelEdit" id="CurSel'.$cols.'" style="display: none;" value="'.$ArrConsul[$cols]['NomCur'].'">'.
                                        '<label for="CurSel'.$cols.'">'.$ArrConsul[$cols]['NomCur'].'<br>Impartido por: '.$ArrConsul[$cols]['NomProf'].' '.$ArrConsul[$cols]['Ape_Pat'].'</label>'.
                                    '</div>';
                            }
                            echo    '</div>'.
                            '</div>';
                    ...
                    <div class="row">
                        <div class="col-md-3 col-md-offset-2">
                            <label class="btn btn-success">
                                <input type="submit" name="enviar" id="send" style="display: none;" onclick="return RevSel('CurSelEdit','AdErr');">
