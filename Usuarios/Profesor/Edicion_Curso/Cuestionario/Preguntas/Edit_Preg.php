<?php
    require '../../../../../Funcionamiento/PHPs/Carga_Datos/CEdit_Preg.php';
    //require '../../../../../Funcionamiento/PHPs/Cuestionario/Edit_Preg.php';
?>
<!DOCTYPE html>
<html>
<head>
...
<body class="bg-primary">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <form action="../../../../../Funcionamiento/PHPs/Cuestionario/Edit_Preg.php" method="post" enctype="multipart/form-data"><!---->
                            <div class="form-group">
                                <div class="row" style="padding-left: 8%;">
                                    <div class="col-md-5">
                                        <h3><span class="label label-default">Tipo de pregunta: </span></h3>
                                        <select class="btn btn-default" name="Tip_Preg" id="Text_Preg" onclick="SelResp(this.value);">
                                            <?php
                                                switch($Tipo)
                                                {
                                                    case 1:
                                                        echo '<option value="1" selected>Opcion multiple, 4 alternativas y una respuesta correcta</option>
                                                            ...
                                                            <option value="6" onclick="CantList_Opc1();">Completa la oracion</option>
                                                            <option value="7">Escala de Linkert</option>';
                                                        break;

                                                    case 2:
                                                        echo '<option value="1">Opcion multiple, 4 alternativas y una respuesta correcta</option>
                                                        <option value="2" selected>Opcion multiple, 7 alternativas y varias respuestas correctas</option>
                                                        <option value="3">Cierto y Falso</option>
                                                        <option value="4">Relacion de columnas</option>
                                                        <option value="5">Orden de seleccionado</option>
                                                        <option value="6" onclick="CantList_Opc1();">Completa la oracion</option>
                                                    ...
                                                    case 3:
                                                        echo '<option value="1">Opcion multiple, 4 alternativas y una respuesta correcta</option>
                                                        <option value="2">Opcion multiple, 7 alternativas y varias respuestas correctas</option>
                                                        <option value="3" selected>Cierto y Falso</option>
                                                        <option value="4">Relacion de columnas</option>
                                                        <option value="5">Orden de seleccionado</option>
                                                        <option value="6" onclick="CantList_Opc1();">Completa la oracion</option>
                                                        <option value="7">Escala de Linkert</option>';
                                                    ...
                                                    case 4:
                                                        ...
                                                        <option value="2">Opcion multiple, 7 alternativas y varias respuestas correctas</option>
                                                        <option value="3">Cierto y Falso</option>
                                                        <option value="4" selected>Relacion de columnas</option>
                                                        <option value="5">Orden de seleccionado</option>
                                                        <option value="6" onclick="CantList_Opc1();">Completa la oracion</option>
                                                        <option value="7">Escala de Linkert</option>';
                                                        break;
                                                    ...
                                                    case 5:
                                                        ...
                                                        <option value="3">Cierto y Falso</option>
                                                        <option value="4">Relacion de columnas</option>
                                                        <option value="5" selected>Orden de seleccionado</option>
                                                        <option value="6" onclick="CantList_Opc1();">Completa la oracion</option>
                                                        <option value="7">Escala de Linkert</option>';
                                                        break;
                                                    ...
                                                    case 6:
                                                        ...
                                                        <option value="4">Relacion de columnas</option>
                                                        <option value="5" selected>Orden de seleccionado</option>
                                                        <option value="6" onclick="CantList_Opc1();" selected>Completa la oracion</option>
                                                        <option value="7">Escala de Linkert</option>';
                                                        break;
                                                    ...
                                                    case 7:
                                                        ...
                                                        <option value="5" selected>Orden de seleccionado</option>
                                                        <option value="6" onclick="CantList_Opc1();">Completa la oracion</option>
                                                        <option value="7" selected>Escala de Linkert</option>';
                                                        break;
                                                }
                                            ?>
                                        </select>
                                    ...
                                    <div class="col-md-5 col-md-offset-1">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <?php
                                                if($Tipo==6)
                                                {
                                                    echo '<input type="text" name="Pregunta" id="TextPreg" class="form-control" value="'.$Pregunta.'">';
                                                }
                                                else
                                                {
                                                    echo '<input type="text" name="Pregunta" id="TextPreg" class="form-control" placeholder="'.$Pregunta.'">';
                                                }
                                            ?>
                                            <span class="input-group-addon">?</span>
                                        </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-3 col-md-offset-2">
                                        <button type="submit" class="form-control btn btn-success active" name="enviar">Finalizar edicion de pregunta</button>
                                    </div>
                                    <div class="col-md-3 col-md-offset-2">
                                        <a href="Sel_Edit_Preg.php" class="form-control btn btn-danger"><span class="glyphicon glyphicon-remove-circle"></span> Cancelar</a>
                                    </div>
                                </div>
                            </div>
                        </form>
    ...
    <script>
        $(function () 
        {
            ...
            document.getElementById('Text_Preg').click();
        });
    </script>
</body>
</html>