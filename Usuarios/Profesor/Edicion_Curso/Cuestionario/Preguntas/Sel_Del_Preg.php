...
<html>
    ...
    <body>
        <div class="container">
            ...
            <form action="../../../../../Funcionamiento/PHPs/Del_Pregs.php" method="post">
                <?php
                        ...
                        for($cols=$fils*3,$cont1=0;$cont1<=2;$cols++,$cont1++)
                        {
                            ...
                            if($Pregs[$cols]['Preg']=='')
                            {
                                echo '<div class="col-md-3 col-md-offset-1 text-center" style="border: 2px solid black; border-radius: 15px; background-color: gold;">'.
                                    '<input type="radio" name="SelDelPreg" id="DelPreg'.$cols.'" style="display: none;" value="'.$Pregs[$cols]['ID_Preg'].'">'.
                                    '<label for="DelPreg'.$cols.'">Pregunta '.$Pregs[$cols]['Num_Preg'].':<br>'.$Pregs[$cols]['Preg'].'</label>'.
                                '</div>';
                            }
                            else
                            {
                    ...
                    <div class="row">
                        <div class="col-md-3 col-md-offset-2">
                            <label class="btn btn-success">
                                <input type="submit" name="enviar" id="send" style="display: none;" onclick="return RevSel('SelDelPreg','AdErr');">
