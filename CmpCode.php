                        ...
                        <div class="form-group">
                            <div class="panel panel-success">
                                <div class="panel-heading">
                                    <p style="font-family: 'Open Sans', sans-serif;color:green;">Por favor introduce los datos solicitados.</p>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-3">
                                                    <input type="checkbox" onclick="showpass('wordR')"> Ver palabra clave
                                                </div>
                                            </div>
                                            <div class="form-group row">
