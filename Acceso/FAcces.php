        ...
        <div class="container">
            <div class="row title">
                <div class="col-md-8 col-md-offset-2">
                    <h1 align="center" class="text-info" style="font-family: 'Raleway', sans-serif;"><strong>Bienvenido</strong></h1>
                </div>
                <!-- <div class="col-md-2">
            ...
            <div class="panel panel-default" style="box-shadow: 0 2px 2px 2px rgba(0,0,0,0.3);">                
                <div class="panel-body">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                <h3 class="text-center text-danger" style="font-family: 'Roboto', sans-serif;">Por favor, ingresa tus datos para comenzar</h3>
                                <br><br>
                            </div>
                        </div>                        
                    </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-5 col-md-offset-3">
                                        <label><input type="checkbox" onclick="showpass('pass')"> Mostrar contraseña</label>
                                    </div>
                                </div>
                            </div><br>
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2">
                                        <h4 style="font-family: 'Roboto', sans-serif;">
                                            ¿Olvidaste tu contraseña?, presiona <a href="../Funcionamiento/PHPs/Rec_Pass.php" class="link">
                                                Aqui</a> para establecer una nueva.
                                        </h4>
                                    </div>
                                </div>
                            </div>
